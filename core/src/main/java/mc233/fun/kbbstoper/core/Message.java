...
public enum Message {
    ...
    GUI2_STATUS_FIRST("gui2.status.first"),
    GUI2_STATUS_EXTRA1("gui2.status.extra1"),
    GUI2_STATUS_EXTRA2("gui2.status.extra2"),
    ...
    GUI2_RULES_FIRST("gui2.rules.first"),
    GUI2_RULES_EXTRA("gui2.rules.extra"),
    GUI2_RULES_ADDITIONAL("gui2.rules.additional"),
    GUI2_RULES_OFFPEAK("gui2.rules.offpeak"),
    GUI2_RULES_HPCAP("gui2.rules.hpcap"),
    GUI2_RULES_CUMULATIVE("gui2.rules.cumulative"),
    GUI2_RULES_GROWTH("gui2.rules.growth"),
    GUI2_RULES_REWARD("gui2.rules.reward"),
